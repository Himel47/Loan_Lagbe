...
namespace LoanData.Migrations
{
    ...
    [Migration("20230609095525_IsLoanPlannedNotNull")]
    partial class IsLoanPlannedNotNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoanData.Models.Loan.InstallmentPayment", b =>
                {
                    ...
                    b.Property<long?>("LoanBasicLoanId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LoanData.Models.Loan.InstallmentPayment", b =>
                {
                    b.HasOne("LoanData.Models.Loan.LoanBasic", "LoanBasic")
                        .WithMany()
                        .HasForeignKey("LoanBasicLoanId");

                    b.HasOne("LoanData.Models.Loan.SubmissionPeriod", "SubmissionPeriod")
                        .WithMany()
                        .HasForeignKey("SubmissionPeriodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoanBasic");
